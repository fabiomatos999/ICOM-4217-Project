...
\begin{table}[!ht]
  ...
  \end{tabularx}
\end{table}
\createfigurew{../Modular Design/Main-Unit-PSU/Figures/main-unit-3.3V-1.jpeg}{Main unit PSU 3.3V Output Picture 1}{fig:main-unit-psu-1}
\createfigurew{../Modular Design/Main-Unit-PSU/Figures/main-unit-3.3V-2.jpeg}{Main unit PSU 3.3V Output Picture 2}{fig:main-unit-psu-2}
\createfigurew{../Modular Design/Main-Unit-PSU/Figures/main-unit-4V.jpeg}{Main unit PSU 4V Output Picture}{fig:main-unit-psu-3}
