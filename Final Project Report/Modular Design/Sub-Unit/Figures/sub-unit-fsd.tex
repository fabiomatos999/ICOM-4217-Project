...
\label{fig:sub-unit-modular-fsd-diagram}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
      ...
      \label{fig:sub-unit-modular-fsd-state-outputs}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
   \begin{tabular}{|c|}
    \hline
   ...
   \end{tabular}
      ...
      \label{fig:sub-unit-modular-fsd-outputs-list}
  \end{subfigure}
\caption{Sub Unit Functional State Diagram}
\label{fig:sub-unit-modular-fsd}
\end{center}
\end{figure}
