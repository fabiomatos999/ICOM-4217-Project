...
\createfigurewsvg{../BDv5/Figures/bdv5-main.svg}{Main Unit Architectural Block Diagram}{fig:main-bd-indv}
...
\createfigurel{../Individual-BD-SCH-Pictures/Figures/main-unit-pic-1.jpeg}{Main unit Picture 1}{fig:main-unit-pic-1}
\createfigurel{../Individual-BD-SCH-Pictures/Figures/main-unit-pic-2.jpeg}{Main unit Picture 2}{fig:main-unit-pic-2}
\subsection{Sub Unit}
\subsubsection{Block Diagrams}
\createfigurewsvg{../BDv5/Figures/bdv5-sub.svg}{Sub Unit Architectural Block Diagram}{fig:sub-bd-indv}
\subsubsection{Schematics}
\begin{landscape}
  \begin{center}
  \begin{figure}[H]
...
\createfigurew{../Individual-BD-SCH-Pictures/Figures/main-unit-4V.jpeg}{Main unit PSU 4V Output Picture}{fig:main-unit-psu-3}
